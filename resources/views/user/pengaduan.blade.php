  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="/dashboard/form-pengaduan">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Buat Pengaduan Anda</h1>
      </div>
      <form action="/dashboard/form-pengaduan" method="POST">
        @method('post')
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <textarea name="pesan_pengaduan" id="pesan_pengaduan" class="form-control" rows="3"></textarea>
        </div>
